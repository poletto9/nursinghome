    ...
    <section id="team">
        <div class="container">
            ...
            <div class="row room_fac_type">
                ...
                {{--<div class="person col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-0" style="background-image: url('images/team-3.jpg');">--}}
                    {{--<div class="info">--}}
                        {{--<p>Holistic Activities</p>--}}
                        {{--<h5><a href="javascript:void(0)"><button id="myBtnfac5" class="button button1">More Details</button></a></h5>--}}
                    {{--</div>--}}
                {{--</div>--}}
...
<!--                        <h5><a href="javascript:void(0)"><button id="myBtn6" class="button button1">More Details</button></a></h5>-->
<!--                    </div>-->
<!--                </div>-->
            </div>
            <!-- TEAM ROW 2 END -->
            ...
            <div class="modal-content" style="background: #eada85; border-top: 30px solid #2c0000; border-bottom: 30px solid #2c0000">
                ...
                <div class="image-gallery">
                    <div class="big-image">
                        ...
                        <img id="default" src="images/cafe/cafe.jpg" />
                    </div>
                    <div>
            ...
            <div class="modal-content" style="background: #eada85; border-top: 30px solid #2c0000; border-bottom: 30px solid #2c0000">
                ...
                <div class="image-gallery">
                    <div class="big-image">
                        ...
                        <img id="default2" src="images/pool/pool.jpg" />
                    </div>
                    <div>
            ...
            <div class="modal-content" style="background: #eada85; border-top: 30px solid #2c0000; border-bottom: 30px solid #2c0000">
                ...
                <div class="image-gallery">
                    <div class="big-image">
                        ...
                        <img id="default3" src="images/exercise/exercise.jpg" />
                    </div>
                    <div>
            ...
            <div class="modal-content" style="background: #eada85; border-top: 30px solid #2c0000; border-bottom: 30px solid #2c0000">
                ...
                <div class="image-gallery">
                    <div class="big-image">
                        ...
                        <img id="default4" src="images/massage/massage.jpeg" />
                    </div>
                    <div>
            ...
            {{--<div class="modal-content" style="background: #eada85; border-top: 30px solid #2c0000; border-bottom: 30px solid #2c0000">--}}
                ...
                {{--<div class="image-gallery">--}}
                    {{--<div class="big-image">--}}
                        ...
                        {{--<img id="default5" src="images/services.jpg" />--}}
                    {{--</div>--}}
                    {{--<div>--}}
                    ...
                    {{--<div class="popup-img-content">--}}
                        ...
                        {{--<p class="tab article_content">--}}
                            {{--กิจกรรมศาสตร์องค์รวมเพื่อสุขภาพ เพื่อดูแลสุขภาวะกาย จิต สังคม และจิตวิญญาณ--}}
                        {{--</p>--}}
                    {{--</div>--}}
                {{--</div>--}}
            {{--</div>--}}
