...
<body data-spy="scroll" data-target="#top-navigation">
        ...
        <div class="navbar_header">
            <div class="translate_menu">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-6">
                        <div class="google-translate-border">
                            Google Translate
                        </div>
                    </div>
            ...
            {{--<div class="row no-padding navbar_menu">--}}
                {{--<div class="col-lg-2 col-md-2">--}}
                    {{--<a href="{{ url('/') }}" class="btn btn-warning" role="button">Home</a>--}}
                {{--</div>--}}
                {{--<div class="col-lg-2 col-md-2">--}}
                    {{--<a href="{{ url('rooms') }}" class="btn btn-warning" role="button">Rooms</a>--}}
                {{--</div>--}}
                {{--<div class="col-lg-2 col-md-2">--}}
                    {{--<a href="{{ url('service') }}" class="btn btn-warning" role="button">A.E.C. Clinic</a>--}}
                {{--</div>--}}
                {{--<div class="col-lg-2 col-md-2">--}}
                    {{--<a href="{{ url('care-giver') }}" class="btn btn-warning" role="button">Care Giver</a>--}}
                {{--</div>--}}
                {{--<div class="col-lg-2 col-md-2">--}}
                    {{--<a href="{{ url('facility') }}" class="btn btn-warning" role="button">Facility</a>--}}
                {{--</div>--}}
                {{--<div class="col-lg-2 col-md-2">--}}
                    {{--<a href="{{ url('contact-us') }}" class="btn btn-warning" role="button">Contact Us</a>--}}
                {{--</div>--}}
            {{--</div>--}}
            {{--<div>--}}
                {{--<ul class="nav nav-pills nav-justified navbar_menu">--}}
                    {{--<li role="presentation"><a href="{{ url('/') }}" class="btn" role="button">Home</a></li>--}}
                    {{--<li role="presentation"><a href="{{ url('rooms') }}" class="btn" role="button">Rooms</a></li>--}}
                    {{--<li role="presentation"><a href="{{ url('service') }}" class="btn" role="button">Service</a></li>--}}
                    {{--<li role="presentation"><a href="{{ url('care-giver') }}" class="btn" role="button">Care Giver</a></li>--}}
                    {{--<li role="presentation"><a href="{{ url('facility') }}" class="btn" role="button">Facility</a></li>--}}
                    {{--<li role="presentation"><a href="{{ url('contact-us') }}" class="btn" role="button">Contact Us</a></li>--}}
                {{--</ul>--}}
            {{--</div>--}}
    ...
    <div class="navbar_footer">
        ...
        <div><img src="{{ url('assets/images/telephone.png') }}" class="footer_img">
            095-890-5178, 095-890-5178, 095-890-5178</div>
